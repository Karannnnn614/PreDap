 ...
 * tangible. The demo is interactive — clicking the highlighted button or "Next"
 * advances through the steps and loops. All idle motion respects
...
const STEPS = [
  {
    ...
    hint: "Click the highlighted button — we'll guide the rest.",
  },
  {
    title: "Name your workspace",
    hint: "Pick a name your teammates will recognize.",
  },
  {
    title: "Invite your team",
    hint: "Add the people who'll work here with you.",
  },
  {
    title: "You're all set",
    hint: "PreDAP guides every step from here — just ask.",
  },
] as const;
...
const ProductPreview = () => {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[540px]">
      ...
      <div className="relative rounded-2xl border border-white/[0.08] bg-[#0c0e14] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)]">
        ...
        <div className="flex gap-5 p-5">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* Highlighted target — clicking it advances the demo */}
            <div className="relative pt-1">
              ...
              <button
                type="button"
                onClick={advance}
                className="relative flex w-full items-center justify-between rounded-lg bg-gradient-to-r from-brand to-brand-secondary px-4 py-2.5 text-sm font-medium text-white shadow-glow transition-transform hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
              >
                Connect data source
      ...
      {/* Coach-mark — interactive, gently floating */}
      <div className="absolute -bottom-6 right-2 w-60 animate-float rounded-xl border border-white/[0.1] bg-[#0e1118]/90 p-4 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.7)] backdrop-blur-xl sm:-right-8">
        ...
        <p className="mt-2 text-sm font-semibold text-white">{current.title}</p>
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={advance}
            className="group/next inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-xs font-medium text-brand-secondary transition-colors hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/60"
          >
      ...
      {/* Privacy badge — floating on a different beat */}
